  ...
  <div id="main-wrapper">
    <div class="container">
      <div class="row 200%">
        ...
        <!-- Content -->
        <form action="<%=basePath%>servlet/LoginServlet" method="post" id="form1" name="register"
          ...
          <span id="register">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                  href="<%=basePath%>jsp/register.jsp">注册</a> </span>
...
<!--[if lte IE 8]>
<script src="<%=basePath%>js/ie/respond.min.js"></script><![endif]-->
